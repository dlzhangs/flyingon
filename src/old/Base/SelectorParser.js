...
namespace(function (flyingon) {
    ...
    //元素节点
    var element_node = $class(function (prototype) {


        var join = Array.prototype.join;


        $constructor(function (nodes, type, token, name) {
        ...
        //检测属性及伪类值
        prototype.check = function (target) {
        ...
        //转换成css选择器
        //checked: 是否执行转换检查
        prototype.toString = function (css_style) {

            var data = [],
                name = this.name;

            this.type && data.push(this.type);
            ...
            for (var i = 0, _ = this.length; i < _; i++)
            {
                data.push(this[i].toString(css_style));
            }
    ...
    //元素属性 
    var element_property = $class(function (prototype) {
    ...
    //伪类(不含伪元素)
    var pseudo_class = $class(function (prototype) {
        ...
        prototype.check = (function () {
            ...
            var fn = (function () {
                ...
                this["not"] = function (target) {
                    ...
                    return this.length === 0 || !flyingon[".has_selector"](target, this[0]);
                };
        ...
        prototype.toString = function (css_style) {
            ...
            return this.length > 0 ? ":" + this.name + "(" + join.call(this, ",") + ")" : ":" + this.name;
        };
