...
(function (flyingon) {
    ...
    var header_base = function (base, class_prefix) {
        ...
        this.arrange = function (width, height) {
            ...
            (this.__layout = layouts[this.get_layoutType()] || layout_unkown)[".arrange"](this, width, height);
        };
    ...
    var tab_base = function (base, group) {
        ...
        if (group)
        {
            ...
            this[".selectedIndex_class"] = function () {
        ...
        //获取页签数据
        this[".get_tab_values"] = function (collapse, collapse_style) {
    ...
    var tab_control = function (base, class_prefix1, class_prefix2) {
        ...
        this.defineProperty("icon", "", {
            ...
            attributes: "layout",
            set_code: " this['.visible_icon']('__icon', value, value);"
        });
        ...
        this.defineProperty("text", "", {
            ...
            attributes: "layout",
            set_code: "(this.__header || this['.create_header']()).__text.set_text(value);"
        });
        ...
        this.defineProperty("showClose", false, {
            ...
            attributes: "layout",
            set_code: "this['.visible_icon']('__close', value);"
        });
        ...
        this.defineProperty("showCollapse", false, {
            ...
            attributes: "layout",
            set_code: "this['.visible_icon']('__collapse', value);"
        });
        ...
        //显示或隐藏图标
        this[".visible_icon"] = function (name, visible, image) {

            var target = this.__header;

            if (visible)
            {
                (target || (target = this[".create_header"]()))[name].set_visibility("visible");
        ...
        //渲染页签头
        this[".render_header"] = function (box, header, data) {
            ...
            if (data.collapse || data.only_tab)
            {
                ...
                if (data.collapse)
                {
                    header.__collapse[".set_className"](class_prefix2 + "collapse " + class_prefix2 + "expand-" + data.direction);
                }
            ...
            header.__collapse[".set_className"](class_prefix2 + "collapse " + class_prefix2 + "collapse-" + ((cache = this[".parent"]) && (cache = cache.__layout) && cache.__fn_collapse(this) || data.direction));
            header.render();
        };


        //调整大小
        this[".adjust_size"] = function (size, change, vertical) {
    ...
    //页签头控件
    $class("TabPanelHeader", flyingon.Control, function (Class, prototype, base) {



        //扩展页签头基础服务
        header_base.call(prototype, base, "flyingon-TabPanelHeader-");


        prototype["on.bubble.click"] = function (event) {
            ...
            if (target)
            {
                ...
                {
                    target = (parent = target[".parent"]) && parent.set_collapse ? parent : target;
    ...
    //页签面板控件
    $class("TabPanel", flyingon.Panel, function (Class, prototype, base) {
        ...
        $constructor(function () {
            ...
            (this.__header = new flyingon.TabPanelHeader())[".parent"] = this;
        ...
        //扩展页签基础服务
        tab_base.call(prototype, base, false);


        //扩展页签控件基础服务
        tab_control.call(prototype, base, "flyingon-TabPanel-", "flyingon-TabPanelHeader-");



        //宽度权重(当所属页签控件tabFill == true时占比)
        prototype.defineProperty("weightWidth", 100, {
        ...
        prototype.defineProperty("weightHeight", 100, "last-value");
        ...
        prototype.measure = function () {
            ...
            {
                values = this[".get_tab_values"]();
            }

            direction2 = values.direction = values.collapse && cache && (cache = cache.__layout) && cache[".collapse"](this) || values.tab;
            style2 = values.style;
        ...
        prototype.before_measure = function (box) {
            ...
            //渲染页签头
            return this[".render_header"](box, header, values);
        };
    ...
    //页签面板控件集合
    $class("TabPanelCollection", function (Class, prototype) {



        //扩展控件集合接口
        flyingon.IControlCollection(Class, prototype, flyingon.TabPanel);
    ...
    //页签头控件
    $class("TabControlHeader", flyingon.Control, function (Class, prototype, base) {


        //扩展页签头基础服务
        header_base.call(prototype, base, "flyingon-TabControlHeader-");
        ...
        prototype["on.bubble.click"] = function (event) {
            ...
            {
                (target = this[".parent"]).set_collapse(!target.get_collapse());
            }
    ...
    //页签控件
    $class("TabControl", flyingon.Panel, function (Class, prototype, base) {
        ...
        //默认序列化类型
        prototype.deserialize_xtype = flyingon.TabPanel;


        //扩展页签基础服务
        tab_base.call(prototype, base, true);


        //页签控件基础服务
        tab_control.call(prototype, base, "flyingon-TabControl-", "flyingon-TabControlHeader-");



        //是否显示标题头
        prototype.defineProperty("header", true, "arrange");


        //页签是否充满可用空间
        prototype.defineProperty("tabFill", false, "arrange");


        prototype.defaultValue("tabStyle", "tab1");




        prototype[".create_header"] = function () {
        ...
        prototype.measure = function () {
            ...
            var values = this[".get_tab_values"](undefined, "shrink"), //TabControl收拢模式下的TabPanel设为shrink紧缩模式
            ...
            if (this.__collapse_last = values.collapse && (target = this[".parent"]) && (target = target.__layout) && target[".collapse"](this))
            {
        ...
        prototype.before_measure = function (box) {
            ...
            if (header)
            {
                ...
                if (header && this.get_header() && values.style !== "thumb") //缩略图模式不支持标题头
                {
                    ...
                    //获取收拢方向(left, top, right, bottom)
                    if (values.collapse && (cache = this[".parent"]) && (cache = cache.__layout) && (cache = cache[".collapse"](this)))
                    {
        ...
        prototype.arrange = function (width, height) {
            ...
            //取消或设置选中样式
            this[".selectedIndex_class"]();

            //布局
            if ((target = this.__tab_values).collapse)
            {
                (this.__layout = layouts.collapse)[".arrange"](this, width, height);
            }
    ...
    //页签控件
    $class("OutlookBar", flyingon.Panel, function (Class, prototype, base) {
        ...
        prototype.arrange = function (width, height) {
            ...
            //取消或设置选中样式
            this[".selectedIndex_class"]();
            this[".get_tab_values"](false);

            (this.__layout = layout)[".arrange"](this, width, height);
        };
