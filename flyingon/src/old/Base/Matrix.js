...
namespace(function (flyingon) {
    ...
    //move_x	水平移动绘图
    //move_y	垂直移动绘图
    flyingon.Matrix = $class(function (prototype) {


        $constructor(function (scale_x, skew_x, skew_y, scale_y, move_x, move_y) {
        ...
        prototype.fromArray = function (values) {
        ...
        prototype.append = function (scale_x, skew_x, skew_y, scale_y, move_x, move_y) {
