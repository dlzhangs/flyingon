...
flyingon.error({
    ...
    "binding name error": "binding name or source does not allow empty!",
    "serialize no id": "serialize reference object must be set id",
    "$constructor not in class": "function \"$constructor\" can only be call in class!",
    "$static not in class": "function \"$static\" can only be call in class!"
});